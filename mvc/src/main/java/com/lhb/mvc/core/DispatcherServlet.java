...
import com.lhb.mvc.core.converter.HttpMessageConverter;
...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (req.getRequestURI().endsWith(".jsp")) {
            if (req.getRequestURI().startsWith("redirect:")) {
                resp.sendRedirect(req.getRequestURI().replaceAll("redirect:", ""));
            } else {
            ...
            if (!isresponseBody) {
                if (obj.getClass().getSimpleName().equals("String")) {
                    if (obj.toString().startsWith("redirect:")) {
                        response.sendRedirect(obj.toString().replaceAll("redirect:", ""));
                    } else {
